...
<head>
	...
	<!--Page CSS -->
	<link href="editproducttype.css" rel="stylesheet"/>
	...
	<!-- js -->
	<script type="text/javascript" src="editproducttype.js"></script>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">	
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h2 class="page-header">Edit Product Type</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-6">
						<form id="editproductform" method="post" action="editproduct_p.php" enctype="multipart/form-data">
							<div class="col-lg-6 clearl">
								...
								<input class="form-control" type="text" class="textbox" id="pname" name="pname" placeholder="PRODUCT TYPE NAME">
							</div>
							<div class="col-lg-8 underline"> &nbsp;</div>
							<div class="col-lg-6 clearl">
								<input class="btn btn-default" type="submit" value="Edit Product Type" class="btn-style">

...
function getProduct($pageNow,$strSort,$strOrder){
	$str="";
	$uid="";
	$sql = "SELECT prodid,prodname,price,qty,measure,tpy.prodtypename as prodtype,inshop as instock,limitreach as limits FROM tprod tp inner join tprodtype tpy on tpy.prodtypeid = tp.prodtypeid";

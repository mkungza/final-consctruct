...
<head>
	...
	<!--Page CSS -->
	<link href="targetEmployeeDetail.css" rel="stylesheet"/>
	...
	<!-- js -->
	<script type="text/javascript" src="targetEmployeeDetail.js"></script>
							...
							<table class="table table-bordered table-hover table-striped" id="tableuser">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a class="sort" value="transname">Trans Name</a></th>
                                        <th><a class="sort" value="transaddr">Address</a></th>
                                        <th><a class="sort" value="transtel">Tel</a></th>
										<th><a class="sort" value="status">Status</a></th>
										<th>Manage</th>
                                    </tr>
                                </thead>
                                <tbody align=center>

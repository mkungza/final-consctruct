					...
					<div class="col-lg-6">
						<form id="editpurchaseform" method="post" action="editpurchase_p.php" role="form">
							<div class="col-lg-6 clearl">
								<label>Date</label>
								<input class="form-control" type="text" class="textbox" id="datepicker" name="datepicker" placeholder="PURCHASE DATE" disabled="disabled">
							</div>
							<div class="col-lg-6 clearl">
								<label>User</label>
							...
							<div class="col-lg-6 clearl">
								...
								<input type="hidden" id="checkrole" value="<?php echo $_SESSION['role'];?>">
							</div>
						</form>
					</div>
				</div>
